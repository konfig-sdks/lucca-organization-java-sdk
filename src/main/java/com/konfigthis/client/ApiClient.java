...
public class ApiClient extends ApiClientCustom {
    ...
    private String basePath = "https://example.ilucca.net";
    ...
    public ApiClient(OkHttpClient client, Configuration configuration) {
        ...
        if (configuration != null) {
            if (configuration.authorization != null) {
                this.setAuthorization(configuration.authorization);
            }
    ...
    public void setAuthorizationPrefix(String prefix) {
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://example.ilucca.net)
